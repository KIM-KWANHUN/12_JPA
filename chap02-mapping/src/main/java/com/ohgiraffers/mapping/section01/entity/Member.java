...
public class Member {
    ...
    *   - length : 문자열 길이 String 타입만 사용 (기본 255) */
    ...
    // false 로 하면 null을 허용하지 않겠다라는 뜻
    // unique 가 true 면 유일한 값이라는 뜻
    // columnDefinition 우리가 조건을 직접 설정 할 수 있다.
